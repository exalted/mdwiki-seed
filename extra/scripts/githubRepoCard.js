// original code: https://github.com/JoelSutherland/GitHub-jQuery-Repo-Widget
;jQuery(document).ready(function($){
  ...
  $('.github-widget').each(function(){
    ...
    if(i == 0) $('head').append(
      '<style type="text/css">'
      +'.repo {max-width: 350px; min-width: 350px; } '
      +'.github-widget { float: left; margin-right: 15px; margin-bottom: 15px }'
      ...
      +'.github-box .github-box-content{padding:10px;font-weight:300; min-height: 50px; max-height: 50px;}'
    ...
    var $container = $(this), $widget,
      ...
      werckerKey = $container.data('wercker'),
    ...
    var werckerDiv = null;
    if(werckerKey) {
      werckerDiv = '<div class="github-stats">'
        + '<a href="https://app.wercker.com/project/bykey/' + werckerKey + '"><img alt="Wercker status" src="https://app.wercker.com/status/' + werckerKey  +'/s/master"></a> '
        +'</div>'
    } else {
      werckerDiv = ""
    }
